...
import "./OurServicesİtemOne.css"
function OurServicesİtemOne() {
  return (
    <div>
      <Navbar/>
      <İtemBannerOne/>
              ...
              <div className="col-md-12 text-center">
                ...
                <div className="row d-flex justify-content-center">
                  <div className="col-9 mb-5">
                    <h1 className="pb-3">ALIŞVERİŞ TURLARI BİLGİLENDİRME</h1>
...
export default OurServicesİtemOne;
